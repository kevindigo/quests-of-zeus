...
This directory contains debug scripts that are useful for development and troubleshooting but are not part of the formal test suite.
...
These scripts use console.log for output and are not proper unit tests. For formal testing, use the files in the `tests/` directory.